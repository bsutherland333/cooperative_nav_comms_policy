...
def parse_args(argv: Sequence[str] | None) -> RunConfig:
    ...
    parser.add_argument("--num-iters", default=300, type=_positive_int)
    ...
    parser.add_argument("--critic-rate", default=1e-4, type=_positive_float)
    ...
    parser.add_argument("--replay-buffer-size", default=12000, type=_nonnegative_int)
    parser.add_argument("--replay-batch-size", default=120, type=_positive_int)
    parser.add_argument("--replay-warmup-size", default=120, type=_nonnegative_int)
